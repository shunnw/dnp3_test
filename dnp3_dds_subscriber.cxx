...
Example subscription of type dnp3data automatically generated by 
...
int subscriber_main(int domain_id, int sample_count)
{
    ...
    dds::sub::DataReader<dnp3data> reader(dds::sub::Subscriber(participant), topic);
    ...
    {
        // Take all samples
        dds::sub::LoanedSamples<dnp3data> samples = reader.take();
    ...
    while (count < sample_count || sample_count == 0) {
        ...
        // when they activate
        std::cout << "dnp3data subscriber sleeping for 4 sec..." << std::endl;
